...
const clubs = [
  ...
  },
  {
    name: 'IEEE Club',
    logo: 'https://via.placeholder.com/150',
    about: 'The IEEE Club is dedicated to publication and research on IEEE papers.',
    type: 'club',
    description: 'This club trains students in research and thesis on IEEE papers',
    executiveCommittee: {
      chairperson: 'Charlie Adams',
      viceChair: 'Lucy Parker',
      secretary: 'Henry Torres',
